        ...
        <div class="offcanvas-body">
            <div id="content-crud">
                ...
                <div class="mb-3 row">
                    ...
                    <div id="company-group-detail" class="mb-3"></div>
                </div>
                <div class="text-end">
...
<script>
    ...
    $('#form-crud').on('submit', function(e) {
        ...
        let url = '{{ route("coredata.CrudCompany") }}';
        let method = 'POST';
    ...
    var tableDetail = new Tabulator("#company-group-detail", {
        ajaxURL: "{{ route('coredata.getSubCompanyData') }}", // endpoint Laravel
        ajaxConfig: "GET",
    ...
    function actionFormatterDetail(cell) {
        ...
        return `<button type="button" 
            onclick="CrudDetail('update', '${company_id}')" 
        ...
        <button type="button" 
            onclick="CrudDetail('delete','${company_id}')" 
    ...
    function reloadTableDetail() {
        ...
        tableDetail.setData("{{ route('coredata.getSubCompanyData') }}", {
            search: search,
            group_id: $("#group_id").val()
        });
    }

    function CrudDetail(action, company_id) {
        ...
        if (!rowComponent) {
            console.warn("Row tidak ditemukan:", company_id);
            return;
        }

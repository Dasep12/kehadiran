    ...
    <div class="container-xl">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Your work status content here -->
                    <div id="work-status-master"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var table = new Tabulator("#work-status-master", {
        ajaxURL: "{{ route('coredata.getWorkStatusData') }}", // endpoint Laravel
        ajaxConfig: "GET",
        layout: "fitColumns",
    ...
    function reloadTable() {
        ...
        table.setData("{{ route('coredata.getWorkStatusData') }}", {
            search: search
        });
    }
</script>
...
@include('coredata.partials.crud-work-status');
@endsection
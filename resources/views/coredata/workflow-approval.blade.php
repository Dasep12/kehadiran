...
<script>
    ...
    var table = new Tabulator("#workflow-approval", {
        ajaxURL: "{{ route('coredata.getWorkflowApproval') }}", // endpoint Laravel
        ajaxConfig: "GET",
                ...
                cellClick: function(e, cell) {
                    ...
                    new Tabulator(tableEl, {
                        ...
                        columns: [{
                            ...
                            title: "target_employee_id",
                            field: "target_employee_id",
                            visible: false
                        }, {
                            title: "target_position_id",
                            field: "target_position_id",
                            visible: false
                        }, {
                            title: "target_organization_id",
    ...
    function reloadTable() {
        ...
        table.setData("{{ route('coredata.getWorkflowApproval') }}", {
            search: search
        });
    }
</script>
...
@include('coredata.partials.crud-workflow-approval');
@endsection
    ...
    <div class="container-xl">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Your job grade content here -->
                    <div id="job-grade-master"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var table = new Tabulator("#job-grade-master", {
        ajaxURL: "{{ route('coredata.getJobGradeData') }}", // endpoint Laravel
        ajaxConfig: "GET",
        layout: "fitColumns",
    ...
    function actionFormatter(cell) {
        ...
        return `<button type="button" ${disabledEdit} ${clickEdit} class="btn btn-sm btn-outline-primary">
    ...
    function reloadTable() {
        ...
        table.setData("{{ route('coredata.getJobGradeData') }}", {
            search: search
        });
    }
</script>
...
@include('coredata.partials.crud-job-grade');
@endsection
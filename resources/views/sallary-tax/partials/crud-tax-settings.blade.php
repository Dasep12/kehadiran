    ...
    <form id="form-crud" method="POST" action="">
        ...
        <div class="offcanvas-body">
            <div id="content-crud">
                ...
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Config Code</label>
                    <div class="col">
                        <input type="text" name="config_code" id="config_code" class="form-control" aria-describedby="emailHelp" placeholder="Enter Config Code">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input type="text" name="value" id="value" class="form-control" aria-describedby="amountHelp" placeholder="Enter value">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input type="text" name="description" id="description" class="form-control" aria-describedby="amountHelp" placeholder="Enter description">
                    </div>
                </div>
...
<script>
    function Crud(action, id) {
        ...
        $('#config_code').attr('readonly', false); // ID biasanya selalu readonly
        ...
        switch (action) {
            case 'create':
                $('#offcanvasEndLabel').text('Create Tax Setting');
                break;

            case 'update':
                $('#config_code').attr('readonly', true); // Config Code tidak bisa diubah saat update
                $('#offcanvasEndLabel').text('Edit Tax Setting');
                break;

            case 'delete':
                $('#offcanvasEndLabel').text('Delete Tax Setting');
    ...
    $('#form-crud').on('submit', function(e) {
        ...
        let url = '{{ route("sallaryTax.CrudTaxSettings") }}';
        let method = 'POST';

        let formData = {
            config_code: $('#config_code').val(),
            value: $('#value').val(),

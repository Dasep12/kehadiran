        ...
        <div class="offcanvas-body">
            <div id="content-crud">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input type="text" name="description" id="description" class="form-control" aria-describedby="descriptionHelp" placeholder="Enter description">
                    </div>
                </div>
...
<script>
    function Crud(action, id) {
        ...
        switch (action) {
            case 'create':
                $('#offcanvasEndLabel').text('Create Tax PTKP');
                break;

            case 'update':
                $('#ptkp_code').attr('readonly', true); // ID tidak bisa diubah saat update
                $('#offcanvasEndLabel').text('Edit Tax PTKP');
                break;

            case 'delete':
                $('#offcanvasEndLabel').text('Delete Tax PTKP');
    ...
    $('#form-crud').on('submit', function(e) {
        ...
        let url = '{{ route("sallaryTax.CrudTaxPtkp") }}';
        let method = 'POST';

    ...
    <form id="form-crud" method="POST" action="">
        ...
        <div class="offcanvas-body">
            <div id="content-crud">
                ...
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">PTKP Code</label>
                    <div class="col">
                        <input type="text" name="ptkp_code" id="ptkp_code" class="form-control" aria-describedby="emailHelp" placeholder="Enter PTKP Code">
                    </div>
                </div>


                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Min Sallary</label>
                    <div class="col">
                        <input type="text" name="min_salary" id="min_salary" class="form-control" aria-describedby="amountHelp" placeholder="Enter min salary">
                    </div>
                </div>

                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Max Sallary</label>
                    <div class="col">
                        <input type="text" name="max_salary" id="max_salary" class="form-control" aria-describedby="amountHelp" placeholder="Enter max salary">
                    </div>
                </div>

                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Rate</label>
                    <div class="col">
                        <input type="text" name="rate" id="rate" class="form-control" aria-describedby="amountHelp" placeholder="Enter rate">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input type="date" name="effective_date" id="effective_date" class="form-control" aria-describedby="startDateHelp" placeholder="Enter start date">
                    </div>
                </div>
...
<script>
    function Crud(action, id) {
        ...
        $('#ptkp_code').attr('readonly', false); // ID biasanya selalu readonly
        ...
        switch (action) {
            case 'create':
                $('#offcanvasEndLabel').text('Create Tax TER');
                break;

            case 'update':
                $('#id').attr('readonly', true); // ID tidak bisa diubah saat update
                $('#offcanvasEndLabel').text('Edit Tax TER');
                break;

            case 'delete':
                $('#offcanvasEndLabel').text('Delete Tax TER');
    ...
    $('#form-crud').on('submit', function(e) {
        ...
        let url = '{{ route("sallaryTax.CrudTaxTer") }}';
        let method = 'POST';

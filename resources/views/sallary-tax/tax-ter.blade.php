...
<script>
    ...
    var table = new Tabulator("#tax-ter-master", {
        ajaxURL: "{{ route('sallaryTax.getTaxTerData') }}", // endpoint Laravel
        ajaxConfig: "GET",
        // 🔥 layout fix (penting)
        layout: "fitData",
        // layout: "fitColumns",
    ...
    function reloadTable() {
        ...
        table.setData("{{ route('sallaryTax.getTaxTerData') }}", {
            search: search
        });
    }
</script>
...
@include('sallary-tax.partials.crud-tax-ter');
@endsection
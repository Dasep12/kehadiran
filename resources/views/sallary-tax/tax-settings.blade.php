        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="tax-settings-master"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var table = new Tabulator("#tax-settings-master", {
        ajaxURL: "{{ route('sallaryTax.getTaxSettingsData') }}", // endpoint Laravel
        ajaxConfig: "GET",
        // 🔥 layout fix (penting)
        // layout: "fitData",
        layout: "fitColumns",
    ...
    function actionFormatter(cell) {
        let clickEdit = canEdit == true ? `onclick="Crud('update', '${cell.getRow().getData().config_code}')"` : '';
        let clickDelete = `onclick="Crud('delete', '${cell.getRow().getData().config_code}')"`;

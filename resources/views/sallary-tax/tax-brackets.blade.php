        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="tax-brackets-master"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var table = new Tabulator("#tax-brackets-master", {
        ajaxURL: "{{ route('sallaryTax.getTaxBracketsData') }}", // endpoint Laravel
        ajaxConfig: "GET",
        // 🔥 layout fix (penting)
        // layout: "fitData",
        layout: "fitColumns",
    ...
    function reloadTable() {
        ...
        table.setData("{{ route('sallaryTax.getTaxBracketsData') }}", {
            search: search
        });
    }
</script>
...
@include('sallary-tax.partials.crud-tax-brackets');
@endsection
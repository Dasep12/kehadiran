     ...
     <div class="row w-full">
         ...
         <div class="col-md-auto col-sm-12">
             <div class="ms-auto d-flex flex-wrap btn-list">
                 ...
                 <button type="button" onclick="reloadTableGroupShift()" class="btn btn-icon" aria-label="Button">
                 ...
                 <button class="btn btn-outline-primary" data-bs-toggle="offcanvas" type="button" onclick="CrudGroupShift('create','*')" data-bs-target="#offcanvasEnd" role="button" aria-controls="offcanvasEnd"> Create </button>
             </div>
         </div>
     </div>
     <!-- Your education content here -->
     <div id="worktime-shift-group"></div>
 </div>
 ...
 <script>
     ...
     function actionFormatter(cell) {
         return `<button type="button" onclick="Crud('update', '${cell.getRow().getData().shift_group_id}')" class="btn btn-sm btn-outline-primary">
        ...
        <button type="button" onclick="Crud('delete', '${cell.getRow().getData().shift_group_id}')" class="btn btn-sm btn-outline-danger">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1">
     ...
     function reloadTableGroupShift() {
         const search = document.getElementById("search-input").value;

         tableGroupShift.setData("{{ route('worktime.getShiftGroupData') }}", {
             search: search
         });
     }
 </script>

 ...
 <script>
     ...
     function actionFormatterOvertimeGruop(cell) {
         let clickEdit = canEdit == true ? `onclick="CrudOvertimeGroup('update', '${cell.getRow().getData().id}')"` : '';
         let clickDelete = `onclick="CrudOvertimeGroup('delete', '${cell.getRow().getData().id}')"`;

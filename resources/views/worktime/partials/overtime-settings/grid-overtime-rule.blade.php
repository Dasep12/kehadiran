 ...
 <script>
     ...
     function actionFormatterOvertimeRule(cell) {
         let clickEdit = canEdit == true ? `onclick="CrudOvertimeRule('update', '${cell.getRow().getData().id}')"` : '';
         let clickDelete = `onclick="CrudOvertimeRule('delete', '${cell.getRow().getData().id}')"`;

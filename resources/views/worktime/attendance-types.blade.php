...
<script>
    ...
    function actionFormatter(cell) {
        let clickEdit = canEdit == true ? `onclick="Crud('update', '${cell.getRow().getData().code_attendance}')"` : '';
        let clickDelete = `onclick="Crud('delete', '${cell.getRow().getData().code_attendance}')"`;

...
<script>
    ...
    var table = new Tabulator("#settings-users", {
        ajaxURL: "{{ route('settings.getDataUsers') }}", // endpoint Laravel
        ajaxConfig: "GET",
        layout: "fitColumns",
    ...
    function reloadTable() {
        ...
        table.setData("{{ route('settings.getDataUsers') }}", {
            search: search
        });
    }
</script>
...
@include('settings.partials.crud-users');
@endsection
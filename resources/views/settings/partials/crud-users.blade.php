    ...
    <form id="form-crud" method="POST" action="">
        ...
        <div class="offcanvas-body">
            <div id="content-crud">
                ...
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">User Name</label>
                    <div class="col">
                        <input type="text" name="name" id="name" class="form-control" aria-describedby="educationHelp" placeholder="Enter name">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Email</label>
                    <div class="col">
                        <input type="email" name="email" id="email" class="form-control" aria-describedby="educationHelp" placeholder="Enter email">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Password</label>
                    <div class="col">
                        <input type="password" name="password" id="password" class="form-control" aria-describedby="educationHelp" placeholder="Enter password">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Role</label>
                    <div class="col">
                        <select name="role_id" class="form-control" id="role_id"></select>
                    </div>
                </div>
                <div class="mb-3 row">
...
<script>
    ...
    function loadRoles() {
        $.ajax({
            url: "{{ route('settings.getDataRoles') }}",
            method: 'GET',
    ...
    function Crud(action, id) {
        ...
        switch (action) {
            case 'create':
                $('#offcanvasEndLabel').text('Create User');
                break;

            case 'update':
                $('#offcanvasEndLabel').text('Edit User');
                break;

            case 'delete':
                $('#offcanvasEndLabel').text('Delete User');
    ...
    $('#form-crud').on('submit', function(e) {
        ...
        let url = '{{ route("settings.CrudUsers") }}';
        let method = 'POST';

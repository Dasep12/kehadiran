        ...
        <div class="offcanvas-body">
            <div id="content-crud">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col">
                        <input type="text" name="menu_name" id="menu_name" class="form-control" aria-describedby="educationHelp" placeholder="Enter name">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Menu URL</label>
                    <div class="col">
                        <input type="text" name="menu_url" id="menu_url" class="form-control" aria-describedby="educationHelp" placeholder="Enter Url">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Column No</label>
                    <div class="col">
                        <input type="number" name="column_no" id="column_no" class="form-control" aria-describedby="educationHelp" placeholder="Enter Column No">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Sort</label>
                    <div class="col">
                        <input type="number" name="sort_no" id="sort_no" class="form-control" aria-describedby="educationHelp" placeholder="Enter Sort">
                    </div>
                </div>

                <div class="mb-3 row">
                    <label class="col-3 col-form-label required">Icon</label>
                    <div class="col">
                        <select class="form-control" name="menu_icon" id="menu_icon">
...
<script>
    function Crud(action, id) {
        ...
        switch (action) {
            case 'create':
                $('#offcanvasEndLabel').text('Create Menu');
                break;

            case 'update':
                $('#offcanvasEndLabel').text('Edit Menu');
                break;

            case 'delete':
                $('#offcanvasEndLabel').text('Delete Menu');
    ...
    $('#form-crud').on('submit', function(e) {
        ...
        let url = '{{ route("settings.CrudMenu") }}';
        let method = 'POST';

...
<script>
    ...
    var table = new Tabulator("#settings-roles", {
        ajaxURL: "{{ route('settings.getDataRoles') }}", // endpoint Laravel
        ajaxConfig: "GET",
        layout: "fitColumns",
    ...
    function reloadTable() {
        ...
        table.setData("{{ route('settings.getDataRoles') }}", {
            search: search
        });
    }
</script>
...
@include('settings.partials.crud-roles');
@endsection